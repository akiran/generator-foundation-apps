...
gulp.task('default', ['build', 'server:start'], function() {
  // Watch Sass
  gulp.watch(['./client/assets/scss/**/*', './scss/**/*', './bower_components/foundation-apps/scss/**/*'], ['sass']);

  // Watch JavaScript
  gulp.watch(['./client/assets/js/**/*', './js/**/*', './bower_components/foundation-apps/js/**/*'], ['uglify']);

  // Watch static files
  gulp.watch(['./client/**/*.*', './bower_components/foundation-apps/js/**/*.*', '!./client/templates/**/*.*', '!./client/assets/{scss,js}/**/*.*'], ['copy']);
